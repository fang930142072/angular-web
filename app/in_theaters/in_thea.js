...
(function (angular) {
    var moudule = angular.module("moviecat.in_theaters",['ngRoute','moviecat.http-server']);
    ...
    moudule.config(["$routeProvider", function ($routeProvider) {
        $routeProvider.when('/in_theaters/:page?',{
            ...
            controller:'in_thearersController'
        })
    }])

    moudule.controller('in_thearersController',['$scope','MyService',
        '$routeParams',
        '$route',//改变url锚点值的参数
